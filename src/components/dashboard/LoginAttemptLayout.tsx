...
function LoginAttemptsDashboard() {
  ...
  const [filters, setFilters] = useState<LoginAttemptFilter>({});
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    value={filters.attemptSuccess === undefined ? "" : String(filters.attemptSuccess)}
                    onChange={(e) =>
                      setFilters((prev) => ({
                        ...prev,
                        attemptSuccess: e.target.value === "" ? undefined : e.target.value === "true",
                      }))
                    }
